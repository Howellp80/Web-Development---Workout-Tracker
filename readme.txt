This project had us create a CRUD (Create, Read, Update, Delete) app for tracking completed exercises. The information related to your exercises is stored in a Database. 
...
Now you can add, read, edit, and delete exercises as needed.  :)
